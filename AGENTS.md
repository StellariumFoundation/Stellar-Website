...
- **Two Android Gradle projects**: `android/` (Capacitor, AGP 9.2.1, Gradle 9.4.1) and `StellariumCaller/` (native, AGP 9.2.1, Gradle 9.4.1). Both use Java VERSION_25 target.
