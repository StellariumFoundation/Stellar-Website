...
export const MOCK_BOOKS = [
  {
    title: "Stellarium Literature",
    content: "**Core Texts**\n\n[The Stellarium Book](https://amazon.com)\n[The Architecture of Prosperity](https://notion.so)\n\n**Essays**\n\n[On Pragmatism](https://notion.so)\n[The Nature of Wealth](https://notion.so)",
    notionUrl: null,
    commentFromIndex: "Index of all literature."
  },
  {
    title: "The Stellarium Book",
    content: "# The Stellarium Book\n\nWelcome to the foundation of objective reality and wealth creation.\n\n## Chapter 1: The Law\n\nDo Good. Make money. Have Fun.\n\nThis simple triad forms the basis of all operational excellence. It is fundamentally impossible to construct a sustainable, high-velocity enterprise if any of these three elements is lacking.\n\n(This is a sample excerpt of the book.)",
    notionUrl: "https://notion.so",
    commentFromIndex: "The foundational text."
  },
  {
    title: "The Architecture of Prosperity",
    content: "# The Architecture of Prosperity\n\nHow do we engineer society so that the most profitable action is also the most altruistic action? We call this Structural Incentive Engineering.\n\n**Core Tenets**\n1. Align incentives.\n2. Decentralize execution.\n3. Centralize vision.",
    notionUrl: "https://notion.so",
    commentFromIndex: "Deep dive into policy."
  }
];
...
export const MOCK_QUIZZES = [
  {
    ...
    questions: [
      {
        text: "What is the primary operational mantra of The Stellarium Foundation?",
        options: [
          "Think differently.",
          "Do Good, Make Money, Have Fun.",
          "Power through unity.",
      ...
      {
        text: "According to the Foundation, what is the highest metric of value creation?",
        options: [
          "Wealth",
          "Happiness",
          "Power",
  ...
  {
    topicName: "Policy Engineering",
    questions: [
      {
        text: "What is 'Structural Incentive Engineering'?",
        options: [
          "Constructing physical offices for maximum airflow.",
          "Designing laws where profitable action is beneficial for society.",
          "A taxation model for the ultra-wealthy.",
          "Automating jobs via AI."
        ],
        correctIndex: 1
      }
    ]
