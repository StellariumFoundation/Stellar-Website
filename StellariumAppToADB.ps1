...
$PackageName = "org.stellarium.app"
$LauncherActivity = "org.stellarium.app/.MainActivity"
$ApkPath = Join-Path (Join-Path $PSScriptRoot "android") "app\build\outputs\apk\debug\app-debug.apk"
